        ...
        <div class="content">
            <el-form>
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="處理人賬號：" label-width="300px" >
                                <el-input v-model.trim="UploadModel.handleCode" class="sys-name"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="處理人姓名：" prop="coProgress" label-width="130px" >
                                <el-input v-model.trim="UploadModel.handleName" class="sys-name"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">     
                            <el-form-item label="問題類別：" label-width="300px" >
                                <el-select v-model.trim="UploadModel.questionType">
                                    <el-option
                        ...
                        <el-col :span="12"> 
                            <el-form-item label="問題狀態：" label-width="130px" >
                                <el-select v-model.trim="UploadModel.applyStatusId">
                                    <el-option
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="是否接單：" label-width="300px" >
                                <el-select v-model.trim="UploadModel.isHandle">
                                    <el-option
                ...
                <el-form-item style="text-align:center;margin-top:25px;">
                    <el-button type="primary" style="border-radius:5px;" @click = "questionHandle('UploadModel')" :disabled="isDisable">提交</el-button>
...
export default {
    ...
    methods: {
        //查询合作伙伴信息詳情
        open(){
            this.$store.dispatch('getQuestionFeedBackById', {questionFeedbackId:this.questionFeedbackId})
            // this.$store.dispatch('getQuestionFeedBackById', {"questionFeedbackId":54})
            .then(res => {
                // if(res.data.code == 0){
                    let dataContet = res.data[0].questionFeedBack//问题详情
                    this.fileExistLists = res.data[0].files.qfbfileLst//问题反馈附件
                    this.qhfileLst = res.data[0].files.qhfileLst//问题反馈附件
                    let dataContet2 = res.data[0].questionHandle//反馈处理详情
                    this.UploadModel = {
                        //问题详情
                        ...
                        //反馈处理详情
                        handleCode: dataContet2 ?dataContet2.handleCode:'',
                        handleName: dataContet2 ?dataContet2.handleName:'',
                        remark: dataContet2 ?dataContet2.remark:'',
                        isHandle: dataContet2 ?dataContet2.isHandle:'',
                        questionType: dataContet2 ?dataContet2.questionType:'',
                        handleTime: dataContet2 ?dataContet2.handleTime:'',
                        questionFeedbackId: dataContet2 ?dataContet2.questionFeedbackId:'',
                        deadlineDate: dataContet2 ?dataContet2.deadlineDate:'',
                        isComplete: dataContet2 ?dataContet2.isComplete:'',
                        deadlineDprojIdate: dataContet2 ?dataContet2.deadlineDprojIdate:'',
                        questionHandleId: dataContet2 ?dataContet2.questionHandleId:'',
                        applyStatusId: dataContet ?dataContet.applyStatusId:'',
                    } 
                // }else{
        ...
        getDownload (file) {
            ...
            return `${FILE_URL_79}/tsbg/upload/testdownload1?fileName=`+encodeURI(file)+`&questionHandleId=`+this.UploadModel.questionHandleId
        },
        download (file) {
        ...
        //问题反馈處理附件下载
        getDownload2 (file) {
            // return `http://10.177.118.28:8080/tsbg/upload/testdownload2?fileName=`+file+`&questionFeedbackId=`+this.UploadModel.questionFeedbackId
            return `${FILE_URL_79}/tsbg/upload/testdownload2?fileName=`+encodeURI(file)+`&questionFeedbackId=`+this.UploadModel.questionFeedbackId
        },
        download2 (file) {
            const form = document.createElement('form')
            const formConfig = {

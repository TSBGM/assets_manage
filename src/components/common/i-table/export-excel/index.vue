...
export default {
   ...
   */
    ...
    changeChosenData (val) {
      let chosen = ['select', 'all', 'page']
      if (chosen.includes(val) && !this.syncMap()) {
        this.config.version = 'xlsx'
      }
    }
  }
}
